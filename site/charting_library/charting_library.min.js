(function () {
  function m(a) {
    var b;
    if ('object' !== typeof a || a.constructor && !a.hasOwnProperty('constructor') && !(a.constructor.prototype || {
    }).hasOwnProperty('isPrototypeOf')) return !1;
    for (b in a);
  ...
  function k() {
    ...
    g = arguments.length,
    l = !1;
    'boolean' === typeof f && (l = f, f = arguments[h] || {
    }, h++);
    'object' !== typeof f && 'function' !== typeof f && (f = {
    });
    h === g && (f = this, h--);
    for (; h < g; h++) if (null != (a = arguments[h])) for (b in a) c = f[b],
    e = a[b],
    f !== e && (l && e && (m(e) || (d = Array.isArray(e))) ? (d ? (d = !1, c = c && Array.isArray(c) ? c : [
    ])  : c = c && m(c) ? c : {
