...
var socket = io.connect("http://localhost:9999/", {
   transports: ['websocket', 'polling'], query: {
       name: "ui-test", clientSecert: "0a160529cc681f086572e846939c9471d96def8a0c5e8015f0e01d6d7f07e6af", clientId: "7bac7d45-5138-47d9-8a60-f99f7aa1964a", email: "ratneshp@talentica.com", phone: "+918600147266"
   }
});

//socket.on('oneminutecandle', function (oneminutecandle) {

//    console.log('Candle data - ', oneminutecandle);

//    //let bar = {
//    //    time: oneminutecandle.start * 1000,
//    //    close: oneminutecandle.close
//    //};//

//    //bar.open = +oneminutecandle.open;
//    //bar.high = +oneminutecandle.high;
//    //bar.low = +oneminutecandle.low;
//    //bar.volume = +oneminutecandle.volume;

//    //onRealtimeCallback(bar);
//});

Datafeeds.UDFCompatibleDatafeed = function (datafeedURL, updateFrequency, socket) {
    ...
    this.socket = socket;
    // Initialize/Connect to websocket sever
...
Datafeeds.UDFCompatibleDatafeed.prototype._send = function (url, params, shouldSendHeader) {
    var request = url;
    if (params) {
    ...
    this._logMessage('Datafeed New request: ' + request);
    ...
    if (shouldSendHeader)
        return $.ajax({
            ...
            headers: {
                clientSecert: "0a160529cc681f086572e846939c9471d96def8a0c5e8015f0e01d6d7f07e6af", clientId: "7bac7d45-5138-47d9-8a60-f99f7aa1964a"
            }});
    else
    return $.ajax({
        type: 'GET',
    ...
    if (!this._configuration.supports_group_request) {
        this._send(this._datafeedURL + this._symbolResolveURL, {
            name: symbolName ? symbolName.toUpperCase() : ''
                ...
                .done(function (response) {
                    var dataArr = parseJSONorNot(response);
					var data = dataArr[0];
...
// Datafeeds.UDFCompatibleDatafeed.prototype._historyURL = 'http://tradeserver.azurewebsites.net/data/oneminutecandle';
//Datafeeds.UDFCompatibleDatafeed.prototype._historyURL = 'http://localhost:9999/data/oneminutecandle/searchAll';
Datafeeds.UDFCompatibleDatafeed.prototype._historyURL = '/data/oneminutecandle/searchAll';
...
Datafeeds.UDFCompatibleDatafeed.prototype.getBars = function (symbolInfo, resolution, rangeStartDate, rangeEndDate, onDataCallback, onErrorCallback, firstDataRequest) {
    ...
    this._send(this._datafeedURL + this._historyURL, {
        ...
        //resolution: resolution,
        gt: "start",
        gt_value: rangeStartDate,
        lt: "start",
        lt_value: rangeEndDate,
        //sort : 'start',
        //order : 'desc',
        //limit : 1440
    }, true).
...
//                var ohlPresent = typeof data.o != 'undefined';
                ...
                for (var i = 0; i < barsCount; ++i) {
                    var barValue = {
                        time: data[i].start * 1000,
                        close: +data[i].close
                    };

                    barValue.open = +data[i].open;
                    barValue.high = +data[i].high;
                    barValue.low = +data[i].low;
                    barValue.volume = +data[i].volume;
//                    if (ohlPresent) {
...
//                    }
                ...
                onDataCallback(bars, {noData: nodata, nextTime: ''});
            })
            .fail(function (arg) {
...
Datafeeds.UDFCompatibleDatafeed.prototype.subscribeBars = function (symbolInfo, resolution, onRealtimeCallback, listenerGUID, onResetCacheNeededCallback) {
    ...
    // Connect websocket for specific listener of exchangeSymbol pair
    var that = this;
    console.log("starting oneminutecandle subscribeBars");
    that.socket.on('oneminutecandle', function (oneminutecandle) {

        console.log('Sub oneminutecandle - ', oneminutecandle);
...
Datafeeds.DataPulseUpdater = function (datafeed, updateFrequency) {
    ...
    var update = function () {
        ...
        for (var listenerGUID in that._subscribers) {
            ...
            datafeed._logMessage('Dates Range Right: ' + datesRangeRight);
            //	BEWARE: please note we really need 2 bars, not the only last one
            //	see the explanation below. `10` is the `large enough` value to work around holidays
            var datesRangeLeft = datesRangeRight - that.periodLengthSeconds(resolution, 10);
            datafeed._logMessage('Dates Range Left: ' + datesRangeLeft);
            that._requestsPending++;

            (function (_subscriptionRecord) { // eslint-disable-line
                datafeed._logMessage('DataPulseUpdater update function call getBars');
...
Datafeeds.QuotesPulseUpdater = function (datafeed) {
    ...
    this._datafeed._logMessage('setInterval of : ' + this._updateInterval + "secounds");
    ...
    this._datafeed._logMessage('setInterval of : ' + this._fastUpdateInterval + "secounds");
...
Datafeeds.QuotesPulseUpdater.prototype._updateQuotes = function (symbolsGetter) {
    ...
    this._datafeed._logMessage('_updateQuotes method calling');
    ...
    for (var listenerGUID in this._subscribers) {
        ...
        this._datafeed._logMessage('getQuotes method calling');
