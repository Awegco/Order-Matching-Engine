...
app.factory('socket', function ($rootScope) {
    ...
    var sockt = io.connect(webSocketUrl, {
        transports: ['websocket', 'polling'], query: {
            ...
            clientId: clientid, email: "ratneshp@talentica.com", phone: "+918600147266"
...
app.controller('MyCtrl', ['$scope', '$rootScope', '$http', '$filter', 'socket', '$window', function ($scope, $rootScope, $http, $filter, socket, $window) {
    ...
    setTimeout(function () {
        ...
        socket.emit('orderBookSell', {
            ...
            message: { clientId: clientid, sort: "price", order: "asc", limit: "100", gt: "aggQty", gt_value: "0" }
        ...
        socket.emit('orderBookBuy', {
            ...
            message: { clientId: clientid, sort: "price", order: "desc", limit: "100", gt: "aggQty", gt_value: "0" }
        ...
        socket.emit('matchedPair', {
            ...
            message: { clientId: clientid, sort: "createdDate", order: "desc", limit: "100" }
        ...
        socket.emit('ticker', {
            ...
            message: { clientId: clientid, sort: "_id", order: "desc", limit: "1", status: "updated" }
